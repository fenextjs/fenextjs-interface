export default {
    id: "unitProps",
    name: "UnitProps",
    description: "Enumeraciones que definen las unidades de medida para distancia, peso y volumen.",
    props: [],
    extras: [
        {
            id: "unitDistance",
            title: "Unit_Distance",
            description: "Enumeración que define las unidades de medida para distancia.",
            tableItems: [
        ...
        },
        {
            id: "unitWeight",
            title: "Unit_Weight",
            description: "Enumeración que define las unidades de medida para peso.",
            tableItems: [
        ...
        },
        {
            id: "unitVolumen",
            title: "Unit_Volumen",
            description: "Enumeración que define las unidades de medida para volumen.",
            tableItems: [
                { key: "ML", value: "'ML'", description: "Mililitros." },
                { key: "L", value: "'L'", description: "Litros." },
                { key: "CC", value: "'CC'", description: "Centímetros cúbicos." },
                { key: "CM3", value: "'CM3'", description: "Centímetros cúbicos." },
                { key: "M3", value: "'M3'", description: "Metros cúbicos." },
                { key: "IN3", value: "'IN3'", description: "Pulgadas cúbicas." },
